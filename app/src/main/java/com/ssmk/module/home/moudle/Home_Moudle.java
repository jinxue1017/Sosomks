package com.ssmk.module.home.moudle;
...
public class Home_Moudle<T> implements Home_Moudle_Interface,BaseSuccess<T> {
    private Context mContext;
    private Home_present_Interface mhpi;

    public Home_Moudle(Context context, Home_present_Interface hpi) {
        mContext = context;
        mhpi = hpi;
    }
