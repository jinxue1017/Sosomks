...
public class City_adapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context mContext;
    private List<CityBean.DataBean> mList = new ArrayList<>();
    public City_adapter(CityActivity baseObserBean2, List<CityBean.DataBean> rows) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        adapter.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(mContext, CitySonActivity.class);
