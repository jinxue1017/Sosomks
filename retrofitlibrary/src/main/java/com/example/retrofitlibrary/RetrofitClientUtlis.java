...
public class RetrofitClientUtlis {
    ...
    public static RetrofitClientUtlis getInstance(Context context) {

        if (context != null) {
            mContext = context;
        }
        return new RetrofitClientUtlis(context);
    }
    ...
    private RetrofitClientUtlis(Context context) {
    ...
    public void getshopp(String uri, Observer o) {
        apiService.getshopping(uri)
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(o);
    ...
    public void post3(String uri, Map<String, String> map, Observer o) {
        apiService.executePost2(uri, map)
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    public void executePostJson(String uri, Map<String,String> map, Observer o) {
        apiService.executePost(uri,map)
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
    ...
    public void executePostJson(String uri, RequestBody route, Observer o) {
        apiService.executePostJson(uri, route)
                .subscribeOn(Schedulers.io())
                .unsubscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(o);
